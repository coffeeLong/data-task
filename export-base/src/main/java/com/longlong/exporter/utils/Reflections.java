package com.longlong.exporter.utils;
...
public class Reflections {
	...
	public static Object getFieldValue(Object obj, String fieldName) {
		Field field = null;
		for (String tmpFieldName : StringUtils.split(fieldName, ".")) {
			field = getAccessibleField(obj, tmpFieldName);
			if (field == null) {
				// logger.debug("Could not find field [" + fieldName + "] on target [" + obj +
				// "]");
				return null;
			}
			try {
